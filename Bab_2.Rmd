...
Berdasarkan dari data “Kecamatan Purwakarta Dalam Angka, 2019”, lokasi-lokasi desa yang masuk dalam wilayah tinjuan merupakan desa dengan tipologi yang datar, kemiringan antara 0 – 500 m, dan memiliki luasan 3.39 Km<sup>2</sup> untuk Desa Citalang, 3.84 Km<sup>2</sup> untuk Desa Munjuljaya, 2.79 Km<sup>2</sup> untuk Desa Tegalmunjul, 1.73 Km<sup>2</sup> untuk Desa Nagrikaler, 1.52 Km<sup>2</sup> untuk Desa Sindangkasih, dan 2.23 Km<sup>2</sup> untuk Desa Nagrikidul. Dari sisi kependudukan, desa-desa yang berada dalam wilayah tinjauan dapat dilihat dari Tabel berikut.

```
insert table dari RMarkdown
```
