...
Ketersediaan data untuk Stasiun Cisomang adalah curah hujan harian selama 24 tahun yaitu dari tahun 1995 sampai dengan tahun 2018. Rekapitulasi curah hujan yang akan digunakan ditampilkan pada tabel dan Gambar \ref{data-hujan}.
...
```{r hujan-max, fig.cap="Data Hujan Maksimum \\label{hujan-max}",echo=FALSE, message=FALSE}
library(ggplot2)
library(dplyr)
library(lubridate)
library(kableExtra)
