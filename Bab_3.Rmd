...
Persamaan frekuensi untuk mendeteksi adanya outlier ditampilkan dalam persamaan \ref{eq:uji-outlier}.
...
dimana:
X_H &= Batas (threshold) dari outlier atas, dalam logaritma
$\hat{y}$ &= Nilai rata-rata dari data dalam bentuk logaritma
